...
function quotesOf(data: SectorDataBundle) {
  return (
    data.prices as unknown as { quotes: Record<string, { daily: [string, number, number][] }> }
  ).quotes;
}
...
export function analyzeStock(data: SectorDataBundle, symbol: string): StockTechnical | null {
