...
PROCESS_MAP = [
    ...
    },
    {
        ...
        "equip": ["6501", "7011", "6330", "SMR", "OKLO", "NNE"],
        "material": [],
    },
    {
        "stage": "build",
    ...
    },
    {
        ...
        "equip": ["SMR", "OKLO", "NNE", "7011", "6501", "6330", "BWXT"],
        "material": [],
    },
]
...
PROCESS_MAP.extend([
    {
        ...
        "name": "原発バルブ・特殊機器",
        "icon": "🔧",
        "desc": "高温高圧バルブ・アクチュエータの供給と保守",
        "equip": ["6492", "6466", "6356", "6378", "CW"],
        "material": [],
    },
    {
        "stage": "operate",
        "name": "原発工事・メンテナンス",
        "icon": "🏗️",
        "desc": "定期検査・改良工事・再稼働対応工事",
        "equip": ["1945", "1968", "1966", "1721"],
        "material": [],
    },
    {
        "stage": "build",
        "name": "次世代炉・核融合",
        "icon": "☀️",
        "desc": "SMR・高温ガス炉・核融合の機器と材料",
        "equip": ["7711", "6965", "7011", "LTBR", "BW", "FLR"],
        "material": ["5310"],
    },
])
