        ...
        "steps": [
            ...
            },
            {
                ...
                "roles": [
                    ...
                    {"label": "計装・制御", "codes": ["6841", "6951", "BWXT"]},
            ...
            },
            {
                ...
                "roles": [
                    ...
                    {"label": "SMR(日)", "codes": ["7011", "6501", "6330"]},
                ],
            },
        ],
    },
        ...
        "steps": [
            {
                ...
                "desc": "原子炉の停止・解体・除染",
                "roles": [
                    {"label": "廃炉(日)", "codes": ["6501", "7011", "6301"]},
...
# ===== v3 追加 (2026-07-08): 第5ステージ「次世代炉・核融合」+ 既存ステージ補強 =====
_V3_FLOW_STEPS = {
    "operate": [
        {
            "name": "バルブ・工事・保守",
            "icon": "🔧",
            "desc": "再稼働・定期検査を支える機器と工事",
            "roles": [
                {"label": "原発バルブ", "codes": ["6492", "6466", "6356", "6378"]},
                {"label": "工事・メンテ", "codes": ["1945", "1968", "1966"]},
            ],
        },
    ],
}
...
FLOW.append({
    ...
    "icon": "☀️",
    "color": "#E67E22",
    "desc": "SMR・高温ガス炉・核融合の開発競争。AIデータセンターの電力需要が投資を加速させる新戦線。",
    "visual": "lab",
    "steps": [
        {
            "name": "SMR・次世代炉",
            "icon": "⚛️",
            "desc": "小型モジュール炉・先進炉の開発",
            "roles": [
                {"label": "米国SMR", "codes": ["SMR", "OKLO", "NNE", "BWXT", "FLR"]},
                {"label": "日本重電", "codes": ["7011", "6501", "6503"]},
            ],
        },
        {
            "name": "核融合",
            "icon": "☀️",
            "desc": "ITER・民間核融合の機器・材料",
            "roles": [
                {"label": "機器・材料(日本)", "codes": ["7711", "5310", "6965"]},
                {"label": "米国", "codes": ["LTBR", "BW"]},
            ],
        },
    ],
})
