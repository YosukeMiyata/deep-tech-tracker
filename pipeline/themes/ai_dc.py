...
# =====================================================================
# ★ v3 追加 (2026-07-08) — AIデータセンター拡充
#   DC建設ゼネコン/電力・送配電/通信キャリア/EMS・ODM/発電機・電源設備
...
_V3_NEW_SUBS = {
    "power_dc": [
        {
            "name": "電力会社(DC電力需要)",
            "us": [["TLN", "Talen Energy"], ["NRG", "NRG Energy"]],
            "jp": [
                ["9501", "東京電力HD", "首都圏DC集積の電力供給"],
                ["9503", "関西電力", "関西圏DC・原発比率高で供給余力"],
                ["9506", "東北電力", "仙台圏DC誘致・半導体北上"],
                ["9509", "北海道電力", "石狩・千歳のDC/半導体集積"],
                ["9513", "電源開発(Jパワー)", "卸電力・送電網"],
            ],
            "solo": [],
        },
        {
            "name": "発電機・変電・電源設備",
            "us": [["CMI", "Cummins"], ["GNRC", "Generac"], ["AGX", "Argan"]],
            "jp": [
                ["6508", "明電舎", "変電設備・受配電システム"],
                ["6752", "パナソニックHD", "蓄電池・電源システム"],
            ],
            "solo": [],
        },
    ],
    "server_oem": [
        {
            "name": "EMS・ODM(AIサーバー製造)",
            "us": [["CLS", "Celestica"], ["JBL", "Jabil"], ["FLEX", "Flex"], ["SANM", "Sanmina"]],
            "jp": [
                ["6501", "日立製作所", "ITインフラ・電力の両面でDC需要享受"],
            ],
            "solo": [],
        },
    ],
    "cloud": [
        {
            ...
            "jp": [],
            "solo": [
                ["9433", "KDDI", "国内DC(TELEHOUSE)・生成AI基盤整備"],
                ["9434", "ソフトバンク", "国内AI計算基盤・DC建設(苫小牧等)"],
            ],
        },
    ],
    "capex_cycle": [
        {
            ...
            "solo": [
                ["1801", "大成建設", "大型DC建設の実績"],
                ["1802", "大林組", "DC建設で国内先行"],
                ["1803", "清水建設", "DC・半導体工場建設"],
                ["1812", "鹿島", "DC建設・都市部再開発"],
                ["1959", "九電工", "電気設備工事・九州半導体/DC"],
                ["1982", "日比谷総合設備", "空調・衛生設備工事"],
                ["1721", "コムシスHD", "通信インフラ・DC電気工事"],
            ],
        },
        {
            "name": "ストレージ・データ基盤",
            "us": [["P", "Everpure (旧Pure Storage)"], ["TSM", "TSMC (ADR)"]],
            "jp": [],
            "solo": [],
        },
    ],
